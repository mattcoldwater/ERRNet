...
# python test_errnet_unaligned.py --name my_errnet --hyper -r --icnn_path /data1/kangfu/haoyu/Data/Reflection/checkpoints/my_errnet/errnet_latest.pt --unaligned_loss vgg --gpu_ids 0,1,2,3
